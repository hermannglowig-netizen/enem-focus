...
import { supabase } from "../../../lib/supabase"; // Ajuste o caminho de importação conforme sua estrutura (ex: "@/lib/supabase")
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        // Redireciona para o dashboard (ou para a página de planos se veio de lá)
